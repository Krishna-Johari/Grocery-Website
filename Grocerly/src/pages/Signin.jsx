...
//             <button 
//               type="button"
//               className="py-2.5 px-4 flex justify-center items-center bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-gray-700 w-full transition-all duration-200 text-center text-sm font-semibold shadow-sm hover:shadow-md focus:outline-none"
//             >
...
//             <button 
//               type="button"
//               className="py-2.5 px-4 flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 rounded-xl text-white w-full transition-all duration-200 text-center text-sm font-semibold shadow-sm hover:shadow-md focus:outline-none"
//             >
