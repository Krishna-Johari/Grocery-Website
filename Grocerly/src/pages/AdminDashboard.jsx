...
import {
  ...
  FiSettings, FiSearch, FiBell, FiMenu, FiX,
  FiBarChart2, FiDollarSign, FiTrendingUp,
  FiUserPlus, FiShoppingBag, FiAlertCircle,
  FiCheckCircle, FiList, FiPackage, FiLogOut
} from "react-icons/fi";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const mockOrders = [
      { id: 1, customer: "John Doe", date: "2023-05-15", amount: 125.0, status: "Delivered" },
      { id: 2, customer: "Jane Smith", date: "2023-05-14", amount: 89.5, status: "Processing" },
    ];
    const mockProducts = [
      { id: 1, name: "Basmati Rice", category: "Rice", price: 12.99, stock: 45 },
      { id: 2, name: "Toor Dal", category: "Dal & Pulses", price: 8.5, stock: 32 },
    ];
    const mockUsers = [
  ...
  const renderContent = () => {
    switch (activePage) {
      ...
      case "users":
        return (
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h3 className="font-semibold text-gray-800 mb-4">Users</h3>
            <ul className="space-y-2">
              {users.map((u) => (
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div
        className={`fixed md:relative z-50 w-64 bg-blue-600 text-white transition-all duration-300 ${
          sidebarOpen ? "left-0" : "-left-64"
        } md:left-0 h-full`}
      >
        <div className="p-5 border-b border-blue-500 flex items-center">
...
//   FiBarChart2, FiDollarSign, FiTrendingUp,
//   FiUserPlus, FiShoppingBag, FiAlertCircle,
//   FiCheckCircle, FiList, FiPackage
// } from "react-icons/fi";
// import { useNavigate } from "react-router-dom";
...
//     const adminAuth = JSON.parse(localStorage.getItem("adminAuth"));
//     if (!adminAuth || adminAuth.role !== "admin") {
//       navigate("/"); // redirect non-admins to user home
//     }
//   }, [navigate]);
...
//   FiHome, FiUsers, FiShoppingCart, FiPieChart, 
//   FiSettings, FiSearch, FiBell, FiMenu, FiX,
//   FiBarChart2, FiDollarSign, FiTrendingUp, FiUserPlus,
//   FiShoppingBag, FiAlertCircle, FiCheckCircle, FiList, FiPackage
// } from 'react-icons/fi';
// import { useNavigate } from 'react-router-dom';
...
//   // ✅ Authenticate with token (instead of just localStorage "adminAuth")
//   useEffect(() => {
...
//   // Mock data (you can later replace with real API data if needed)
//   useEffect(() => {
//     const mockOrders = [
...
//   // Activities
//   const activities = [
//     { icon: <FiUserPlus />, title: 'New user registered', description: 'John Doe signed up for a new account', time: '2m ago' },
//     { icon: <FiShoppingBag />, title: 'New order placed', description: 'Order #4562 for $125.00 was placed', time: '15m ago' },
//     { icon: <FiAlertCircle />, title: 'High traffic alert', description: 'Website traffic increased by 28%', time: '1h ago' },
//     { icon: <FiCheckCircle />, title: 'Server updated', description: 'System maintenance completed successfully', time: '3h ago' }
//   ];
...
//         return (
//           <>
//             <h1 className="text-xl font-bold mb-4">{data.message}</h1>
//             <pre className="bg-gray-100 p-4 rounded mb-6">{JSON.stringify(data.user, null, 2)}</pre>
            
//             {/* Existing Stats, Charts, Activities */}
//             {/* ... (keep your previous dashboard UI here) ... */}
//           </>
//         );
//       case 'products':
//         return (
...
//         return (
//           <div className="bg-white rounded-lg shadow-sm p-5">
//             <h3 className="font-semibold text-gray-800 mb-5">{activePage}</h3>
